...
// Builder
RLMDescriptorSet::Builder::Builder(RLMDevice &rlmDevice)
    : rlmDevice{rlmDevice} {}

RLMDescriptorSet::Builder::~Builder() {}

RLMDescriptorSet::Builder &RLMDescriptorSet::Builder::addDescriptorSetLayout(
    RLMDescriptorSetLayout descriptorSetLayout) {
  return *this;
}

RLMDescriptorSet::Builder &RLMDescriptorSet::Builder::createBufferMemory(
    uint32_t bufferSize,
